...
sudo sed -i 's/DB_PASSWORD=secret/DB_PASSWORD='$DB_PASSWORD'/g' /var/www/html/.env
sudo sed -i 's/DB_DATABASE=homestead/DB_DATABASE='$DB_NAME'/g' /var/www/html/.env
sudo sed -i 's/DB_USERNAME=homestead/DB_USERNAME='$DB_USER'/g' /var/www/html/.env
...
sudo /usr/bin/php /var/www/html/artisan view:clear
